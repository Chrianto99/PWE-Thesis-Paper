...
AlgorithmOutput DataHandler::returnData(const map<int, vector<Solution>> &output, const vector<string> &objectiveLabels) {
...
map<int, vector<vector<double>>> DataHandler::createFronts(const map<int, vector<Solution>> &output, const vector<string> &objectiveLabels) {
